...
class _QuickPosScreenState extends State<QuickPosScreen> {
  ...
  void _showConfirmSaleDialog(double currentBalance, WalletProvider wallet) {
                ...
                actions: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      _processSale(finalPrice, appliedCouponDocId, wallet);
                    },
  ...
  Future<void> _processSale(double finalPrice, String? appliedCouponDocId, WalletProvider wallet) async {
    ...
    try {
      ...
      for (var doc in availableCards.docs) {
        ...
        batch.update(doc.reference, {
          ...
          'soldByPhone': auth.activeUserPhone, 
        });
      }
      ...
      QuerySnapshot userSnap = await _db.collection('users').where('phone', isEqualTo: auth.activeUserPhone).limit(1).get();
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 5),
                      Text(
                        _isBalanceHidden ? '****** ريال' : '${wallet.currentUserBalance.toStringAsFixed(0)} ريال', 
                          ...
                          Expanded(
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: _isProcessing ? null : () => _showConfirmSaleDialog(wallet.currentUserBalance, wallet),
