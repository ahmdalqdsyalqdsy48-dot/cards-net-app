...
class _MikrotikCategoriesScreenState extends State<MikrotikCategoriesScreen>
  ...
  // ======================== نافذة إضافة/تعديل سيرفر (بدون تغيير عن السابق) ========================
                                  ...
                                  Wrap(spacing: 4, children: [
                                    ...
                                    IconButton(
                                        icon: Icon(Icons.smart_toy,
                                            color: category['isBotEnabled'] == true
                                                ? Colors.purple
                                                : Colors.grey,
                                            size: 20),
  ...
  // ======================== نافذة إضافة فئة (مع إعدادات المستخدم) ========================
          ...
          child: Directionality(
            ...
            child: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(children: [
                  Expanded(
                      child: _buildUserViewSlider('الأفقي %', userViewX,
                          100, Colors.blue, (v) => userViewX = v)),
                  const SizedBox(width: 10),
                  Expanded(
                      child: _buildUserViewSlider('الرأسي %', userViewY,
                          100, Colors.green, (v) => userViewY = v)),
                ]),
                _buildUserViewSlider('حجم الخط', userViewFontSize, 40,
                    Colors.purple, (v) => userViewFontSize = v),
                Row(children: [
