      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            label:
                const Text('إضافة شريحة', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        );
      },
    );
              ...
              actions: [
                ...
                ElevatedButton(
                    onPressed: () async {
                      ...
                      // تحديث الاسم في Firestore يتطلب docId، سنستخدم الاسم الحالي للبحث عنه
                      final sys = Provider.of<SystemProvider>(context, listen: false);
                      final snap = await _db
                          .collection('print_templates')
                          .where('agentPhone', isEqualTo: sys.currentUserPhone)
