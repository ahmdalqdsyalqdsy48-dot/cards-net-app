...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final bool isDarkMode; // محاكاة لحالة الوضع الليلي

  const CustomAppBar({
    super.key,
    this.title = 'كروت نت', // اسم التطبيق الافتراضي
    this.isOnline = true,    // حالة الاتصال الافتراضية
    this.notificationCount = 3, // عدد الإشعارات الوهمي
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: const [
                    ...
                    SizedBox(width: 8),
                    Text(
                      'مرحباً بك في كروت نت! 🌟 | تحديث جديد: تم إضافة باقات يمن موبايل الجديدة. | نرجو الانتباه لوجود صيانة في نظام الكريمي الليلة الساعة 2 فجراً.',
